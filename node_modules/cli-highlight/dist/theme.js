...
function fromJson(json) {
    ...
    for (const key of Object.keys(json)) {
        ...
        if (Array.isArray(style)) {
            ;
            theme[key] = style.reduce((prev, curr) => (curr === 'plain' ? exports.plain : prev[curr]), chalk);
        }
        else {
            ;
